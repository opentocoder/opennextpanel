...
![站点设置](images/site-settings.png)

- **域名管理**: 添加/删除绑定域名
- **网站目录**: 设置根目录和运行目录
- **访问限制**: IP 白名单/黑名单
- **流量限制**: 限速、并发连接数限制
- **伪静态**: 常用伪静态规则模板（WordPress、ThinkPHP、Laravel）
...
![Docker 容器](images/docker-containers.png)

![Docker 应用商店](images/docker-appstore.png)
